	...
	<form:form id="addVegetablesFamily_form" method="POST" modelAttribute="vegetablesFamily" cssClass="form-horizontal">		
		...
		<div class="form-horizontal" role="form">
			...
			<c:if test="${not empty exception}">
	    	 ...
	    	 <div class="buttons">
	    	 	<button class="btn bold" id="vegetablesFamily_save"><spring:message code="button_save" /></button> 
				<button class="btn bold" id="vegetablesFamily_back"><spring:message code="button_back" /></button>
	    	 </div>
		</div>
	</form:form>
</div>
