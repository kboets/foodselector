...
<div class="right_body">
	...
	<legend class="scheduler-border"><spring:message code="dish_add_subtitle_additive" /></legend>	
		<div class="form-horizontal" role="form">			
	    	...
	    	<div class="form-group">
	    			<form:label path="additiveToChoose" cssClass="control-label col-md-3" ><spring:message code="dish_additive"/></form:label>
	    			<c:set var="additiveSize" value="${fn:length(dishAdditives)}" />  			
	    			<div class="col-md-4">
	    				<form:select path="additiveToChoose" multiple="false" id="all_dishAdditives_list"  size="${additiveSize}px" style="width: 250px" cssErrorClass="errorFormInput">	    	 				
	    				<c:forEach items="${dishAdditives}" var="option" >	    					
	    	 			...
	    	 			<form:errors path="additiveToChoose" cssClass="error" />
	    	 		</div>	    	 		 
	     	</div>
	  	</div>		
		</fieldset>
		...
		<div class="buttons">
			<button class="btn btn-primary bold pull-right RbtnMargin" id="next-button" type="submit" name="_eventId_selectAdditiveType"  ><spring:message code="button.next" /></button>
